...
bool Sudoku::isPossible(int x, int y, int n) {
    return (!columnHasNumber[y][n] and !lineHasNumber[x][n] and !block3x3HasNumber[x/3][y/3][n]);
}

void Sudoku::setNumber(int x, int y, int n) {
    numbers[x][y] = n;
...
void Sudoku::removeNumber(int x, int y, int n) {
    numbers[x][y] = 0;
